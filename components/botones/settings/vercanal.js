    ...
    async execute(interaction, client){
        ...
        if(member.voice.channel){
            ...
            if(voicePermissions.has(PermissionsBitField.Flags.ManageChannels)){
                ...
                if(memberpermis.has(PermissionsBitField.Flags.ViewChannel)) return await msg.edit({ content: `**${user.username} ya puede ver el canal**` })
                ...
                return await msg.edit({ content: `${user.username} puede ver el canal de voz` });
            } else {
